...
function Footer() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response1 = await axios.get(
          `${import.meta.env.VITE_BASE_URL}/superadmin/this-month`
        );
        // console.log(response1 , "response1");
  ...
  return (
    <div className="w-full grid grid-cols-4 px-2 md:px-10 lg:px-20 py-6 gap-4 text-center">
      <div className="flex flex-col justify-center items-center">
        <img
          src="/total-meditators.svg"
          alt="Total"
          className="w-10"
          title="Total Meditators"
        />
        <p className="font-bold text-base" title="Total Meditators">
      ...
      <div className="flex flex-col justify-center items-center">
        <img
          src="/waiting-list.svg"
          alt="Total"
          className="w-10"
          title="Waiting List"
        />
        <p className="font-bold text-base" title="Waiting List">
          {waitinglistcount}
        </p>
        {/* <p>Waiting</p> */}
      </div>
      <div className="flex flex-col justify-center items-center">
        <img
          ...
          title="Beneficiaries"
        />
        <p className="font-bold text-base" title="Beneficiaries">
          {beneficiariescount}
        </p>
        {/* <p>Beneficiaries</p> */}
      </div>
      <div className="flex flex-col justify-center items-center">
        <img
          ...
          title="New Joinees"
        />
        <p className="font-bold text-base" title="New Joinees">
          {newjoineescount}
        </p>
        {/* <p>New</p> */}
      </div>
