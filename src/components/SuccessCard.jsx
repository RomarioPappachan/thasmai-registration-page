        ...
        >
          ...
          <div className="flex justify-center items-center relative">
            ...
            <div className="relative flex flex-col justify-center items-center">
              ...
              />
              <p className="h-6"></p>
              <h3 className="text-base sm:text-lg font-semibold bg-gradient-to-b from-[#3F3E3E] to-[#D09700] inline-block text-transparent bg-clip-text">
          ...
          <div className="flex justify-between p-3 mt-auto">
            <div>
              <p className="text-[10px] sm:text-xs">Cardholder Name</p>
              <h2 className="text-base sm:text-lg font-bold">{ data.first_name } { data.last_name }</h2>
              <p className="text-[10px] sm:text-xs">DOJ: { doj }</p>
            </div>
            <div className="flex flex-col-reverse">
              <p className="text-[10px] sm:text-xs">VALID: 0 days</p>
            </div>
          </div>
        </div>
      </div>
