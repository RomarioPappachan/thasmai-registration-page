...
function HomePage() {
  ...
  return (
    <div className="hero-section w-full h-screen relative flex justify-center items-center">
      <div className="w-24 h-24 md:w-28 md:h-28 flex justify-center items-center bg-gradient-to-b from-[#BA1A1A] to-[#540c0c] rounded-full absolute bottom-16 md:right-12 md:bottom-12 lg:right-20 lg:bottom-20">
        <button
          className="proceed-button w-20 h-20 md:w-24 md:h-24 rounded-full flex justify-center items-center bg-white"
          onClick={() => {
            setIsLangPopUp(true);
          }}
        >
